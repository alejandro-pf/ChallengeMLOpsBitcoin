...
if __name__ == "__main__":
    ...
    #train_model(n_estimators=100, max_depth=25)
    #train_model(n_estimators=100, max_depth=30)
    #train_model(n_estimators=250, max_depth=15)
    #train_model(n_estimators=300, max_depth=15)
    #train_model(n_estimators=350, max_depth=15)
    #train_model(n_estimators=400, max_depth=15)
    #train_model(n_estimators=350, max_depth=25)
    #train_model(n_estimators=350, max_depth=30)
    #train_model(n_estimators=400, max_depth=25)
    #train_model(n_estimators=400, max_depth=30)
    #train_model(n_estimators=450, max_depth=25)
    #train_model(n_estimators=450, max_depth=30)
    train_model(n_estimators=100, max_depth=10)
    train_model(n_estimators=75, max_depth=10)
    train_model(n_estimators=75, max_depth=15)
    train_model(n_estimators=50, max_depth=10)
    train_model(n_estimators=50, max_depth=15)
